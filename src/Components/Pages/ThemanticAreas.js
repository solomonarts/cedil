...
const ThematicAreas = () => {
  ...
  return (
    <div className="thematic-areas-container flex lg:flex-row flex-col mt-10 overflow-hidden">
      ...
      <div className="flex flex-col xl:flex-row gap-5 justify-evenlys mt-10 md:mt-0">
        {thematicAreas.map((area, index) => (
          <div key={index} className="column w-full p-2 relative bg-[#05374413]">
